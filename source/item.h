...
public:
	...
	static Item* Create_RBM(const IOMap& maphandle, BinaryNode* stream);
...
// Deep copy thingy
	...
	*/
	...
	// RBM map interface
		...
		// Used internally
		virtual bool readItemAttribute_RBM(const IOMap& maphandle, RBM_ItemAttribute attr, BinaryNode* stream);
		virtual bool unserializeAttributes_RBM(const IOMap& maphandle, BinaryNode* stream);
		virtual bool unserializeItemNode_RBM(const IOMap& maphandle, BinaryNode* node);

		// Will return a node containing this item
		virtual bool serializeItemNode_RBM(const IOMap& maphandle, NodeFileWriteHandle& f) const;
		// Will write this item to the stream supplied in the argument
		virtual void serializeItemCompact_RBM(const IOMap& maphandle, NodeFileWriteHandle& f) const;
		virtual void serializeItemAttributes_RBM(const IOMap& maphandle, NodeFileWriteHandle& f) const;
