...
bool Map::convert(MapVersionID to, bool showdialog)
{
	...
	if(to.rbm == MAP_RBM_4 && to.client < CLIENT_VERSION_850)
		return false;
...
MapVersionID Map::getVersion() const
{
	return mapVersion;
}
